...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: "Scientific Tracks", href: "#" },
    { label: "Presentation Guidelines", href: "#" },
    { label: "Full Paper Submission", href: "/full-paper-submission" },
      ...
      <nav className="mx-auto flex max-w-[1400px] items-center justify-between px-8 py-4">
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-sm font-bold tracking-wider text-[#0B2A4A] whitespace-nowrap">INTERNATIONAL</span>
            <span className="text-sm font-bold tracking-wider text-[#0B2A4A] whitespace-nowrap">COLLOQUIUM</span>
            <span className="text-xs text-gray-500 font-medium whitespace-nowrap">2025</span>
          </div>
        </div>
