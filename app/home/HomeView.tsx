...
function HomeInner() {
  const { isEditMode, updateItems } = useContent();
  ...
  // ===== Fallback lists (used if DB has no admin overrides) =====
          ...
          <div className="relative">
            <div className="max-w-2xl">
              ...
              <EditableField
                ...
                fallback="Welcome to"
                as="span"
                className="inline-block bg-[#E3D5C0] text-[#8B6F47] text-xs font-bold uppercase tracking-widest px-5 py-2 rounded-sm mb-6 shadow-sm"
              />
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-[#F5F6FA] rounded-xl p-8 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <span key={timeLeft.seconds} className="clock-tick text-5xl font-bold text-[#0B2A4A] tabular-nums">
        ...
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#F5F6FA] p-8 rounded-lg">
            ...
            <EditableField
              section="about_card"
              field="paragraph1"
              fallback="The 3rd International Agri-Life & Bioresource Sciences Symposium brings together researchers, faculty members, students, scientists, government representatives, industry partners, and other stakeholders from the Philippines and abroad."
              as="p"
              className="text-gray-600 text-justify mb-6"
              multiline
            />
            <EditableField
              section="about_card"
              field="paragraph2"
              fallback="Through research presentations, scientific discussions, and collaborative activities, the symposium provides a platform for sharing knowledge and advancing innovative and sustainable solutions in agriculture, life sciences, and bioresource sciences."
              as="p"
              className="text-gray-600 text-justify mb-6"
              multiline
            />
            <a href="/about" className="font-semibold text-[#0B2A4A] inline-flex items-center gap-2 hover:gap-3 transition-all">
              <EditableField
                section="about_card"
                field="link_text"
                fallback="Read More"
          ...
          <div className="bg-white border border-gray-200 p-8 rounded-lg">
            ...
            <EditableList
              ...
              renderItem={(item, index, editing, onUpdate) => (
                <div className={`flex gap-4 ${index < 2 ? "border-b border-gray-200 pb-4" : ""}`}>
                    ...
                    {editing ? (
                      <>
                        <input
                          type="text"
                          value={item.month || ""}
                          onChange={(e) => onUpdate({ ...item, month: e.target.value })}
                        ...
                        <input
                          ...
                          className="w-14 text-center border rounded text-lg font-bold mt-1"
                        />
                      </>
                    ) : (
                      <>
                  ...
                  <div className="flex-1">
                    {editing ? (
                      ...
                      <>
                        <p className="text-xs font-bold text-[#D5A54D] uppercase mb-1">{item.category}</p>
                        <p className="font-semibold text-[#0B2A4A] mb-1">{item.title}</p>
                        <p className="text-sm text-justify text-gray-500">{item.description}</p>
                        <a href={item.link_url} className="mt-3 inline-flex items-center gap-2 font-semibold text-[#0B2A4A] hover:gap-3 transition-all">
          ...
          <div className="bg-[#F5F6FA] p-8 rounded-lg">
            ...
            <EditableField
              section="attendees_card"
              field="title"
              fallback="WHO SHOULD ATTEND"
              as="h3"
              className="text-xl font-bold text-[#0B2A4A] mb-4"
            />
            <div className="w-10 h-1 bg-[#D5A54D] mb-6"></div>
            <EditableField
              section="attendees_card"
              field="description"
              fallback="The symposium welcomes members of the academic, scientific, government, and industry communities who are interested in advancing research, innovation, and collaboration in agri-life and bioresource sciences."
              as="p"
            ...
            <a href="/scientific-tracks" className="font-semibold text-[#0B2A4A] inline-flex items-center gap-2 hover:gap-3 transition-all">
              <EditableField
                section="attendees_card"
                field="link_text"
                fallback="See Who Can Participate"
                as="span"
              />
              <span>→</span>
            </a>
