      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-[#0A2540] uppercase">
              Organized by
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">
              The symposium proposal identifies these institutions as co-hosts
              with CAPSU.
            </p>
          </div>
          ...
          {institutionalPartners.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {institutionalPartners.map(
                (partner: Institution, idx: number) => (
                  <div
                    key={idx}
                    className="bg-[#F8FAFC] rounded-xl border border-zinc-200 p-6 text-center hover:shadow-lg transition-all hover:-translate-y-1"
                  >
      ...
      <section className="py-12 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-xs text-gray-400 text-center mt-6 max-w-2xl mx-auto">
            ...
            your internal proposal on the public page before they formally
            agree.
          </p>
        </div>
      </section>
