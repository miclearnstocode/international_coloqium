...
import {
  ...
  FaInfoCircle, FaCar, FaPlane, FaWalking, FaDownload, FaGlobeAsia, } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-[#0B2A4A] flex flex-col">
      ...
      <section className="relative bg-white overflow-hidden border-b border-zinc-100">
        {/* Floating image — absolutely positioned on the right side */}
        <Image
          src="/images/mapping2.png"
          alt="Hotel & Mapping Illustration"
          width={2200}
          height={500}
          className="opacity-60 hidden md:block absolute top-1/2 -translate-y-1/2 right-8 w-[45%] h-auto object-contain z-10 pointer-events-none"
          priority
        />

        <div className="max-w-350 mx-auto px-8 py-16 relative z-20">
          <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
            <Link href="/" className="hover:text-[#F5A623] transition-colors">
              Home
            </Link>
            <span className="text-zinc-300">›</span>
            <span className="text-[#0B2A4A] font-medium">
              Hotel &amp; Mapping
            </span>
          </div>

          {/* Text — constrained so it doesn't collide with the image */}
          <div className="max-w-xl">
            <h1 className="text-5xl font-bold text-[#0B2A4A] mb-4">
              Hotel &amp; Mapping
            </h1>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500">
                      Explore the event locations and navigate easily within the
                      campus.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl border border-zinc-100 shadow-sm p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500">
                      Click a venue to view details and highlight the location
                      on the map.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {venues.map((venue) => (
                    <div key={venue.id} className="flex gap-4 items-start">
                      <div
                        className={`w-8 h-8 rounded-full ${venue.color} flex items-center justify-center text-sm font-bold text-white shrink-0 mt-1`}
                      >
                        {venue.id}
                      </div>
                      <div>
                        ...
                        <p className="text-xs text-zinc-600 flex items-center gap-1.5">
                          <FaMapMarkerAlt className="text-[#1D3D6D]" />{" "}
                          {venue.loc}
                        </p>
                      </div>
                    </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {venues.map((venue) => (
                <div
                  key={venue.id}
                  className="bg-white border border-zinc-200 rounded-lg p-5 flex items-center justify-between hover:shadow-md transition-shadow"
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-10 h-10 rounded-full ${venue.color} flex items-center justify-center text-base font-bold text-white shrink-0`}
                    >
                      {venue.id}
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-[#1D3D6D] text-lg">
                        {venue.icon}
                      </span>
                      <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">
                    Approximately 10 – 12 hours by car via NLEX • SCTEX • TPLEX
                    • Roxas-Iloilo Road, or via RORO.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">
                    Approximately 15 minutes by car from Roxas City Airport to
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">
                    Approximately 2.5 hours by car via Roxas-Iloilo Road.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">
                    Enter through Capiz SU Main Gate. Follow signage to event
                    venues.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-350 mx-auto px-8">
          <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#0B2A4A] mb-1">
                  Need Assistance?
                </h3>
                <p className="text-zinc-500">
                  Our secretariat is ready to help you with directions and other
                  inquiries.
                </p>
              </div>
            </div>
